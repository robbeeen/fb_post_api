"""
Django settings for fb_learning project.
...
ALLOWED_HOSTS = [
    "fb-learning-prod.apigateway.in",
    "fb-learning-alpha.apigateway.in",
    "fb-learning-beta.apigateway.in",
    "fb-learning-gamma.apigateway.in",
    "fb-learning-staging.apigateway.in",
    "127.0.0.1",
    "localhost"
]

ROOT_URLCONF = 'fb_learning.urls'

CSRF_COOKIE_SECURE = False

WSGI_APPLICATION = 'fb_learning.wsgi.application'
...
LOGGING = {
    ...
    'formatters': {
        ...
        'console': {
            'format': "[%(request_id)s] [fb_learning - "+os.environ.get("STAGE", "local")+
...
# ****************** App Source Config ******************
FB_LEARNING_SOURCE = "fb-learning-source"
