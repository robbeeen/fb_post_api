...
from fb_learning.settings.base import *
...
THIRD_PARTY_SWAGGER_APPS = [
    ...
    "s3_uploader",
    "ib_sentry_wrapper",
    "ib_user_accounts_helper"
]
INSTALLED_APPS += THIRD_PARTY_SWAGGER_APPS

ADDITIONAL_THIRD_PARTY_APPS = [
    "ib_users",
]

INSTALLED_APPS += ADDITIONAL_THIRD_PARTY_APPS

# this will import all settings from [APPS].conf.settings
for app_name in THIRD_PARTY_SWAGGER_APPS + APPS + ADDITIONAL_THIRD_PARTY_APPS:
    try:
...
SWAGGER_UTILS = {
    ...
    "APPS": {
        ...
        "fb_post_auth": {"dsu_version": "1.0"},
    },
    "HOST": os.environ.get('APIGATEWAY_ENDPOINT', '127.0.0.1:8000'),
}

API_KEY_AUTHENTICATION_CLASS = \
    "fb_learning.common.authentication.APIKeyAuthentication"
